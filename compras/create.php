                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="producto" class="form-control" id="producto" disabled>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                            ...
                                            <div class="row">
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="number" name="stock" class="form-control" id="stock" style="background-color: yellow;" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="">Stock Mínimo</label>
                                                        <input type="number" name="stock_min" class="form-control" id="stock_min" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                                        <label for="">Stock Máximo</label>
                                                        <input type="number" name="stock_max" class="form-control" id="stock_max" disabled>
                                                    </div>
                                                </div>
                                                <div class="col-md-3">
                                                    <div class="form-group">
                                        ...
                                        <div class="col-md-4">
                                            <div class="form-group">
                                                ...
                                                <textarea name="descripcion" id="descripcion" cols="1" rows="5" class="form-control" disabled></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea name="" id="direccion" class="form-control" rows="1" disabled></textarea>
                                    </div>
                                </div>
                            </div>
                            <!--End Datos Proveedor -->
                            ...
                            <div class="row">
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" value="<?= $cont_compras; ?>" disabled>
                                        <input type="text" id="nro_compra" value="<?= $cont_compras; ?>" hidden>
                                    </div>
                                </div>
                                <div class="col-md-2">
                                    <div class="form-group">
                                ...
                                <div class="col-md-1">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="stock_actual" style="background-color: yellow;" disabled>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                ...
                                <div class="col-md-2">
                                    <div class="form-group">
                                        <label for="">Usuario</label>
                                        <input type="text" class="form-control" value="<?= $sesion_nombre; ?>" disabled>
                                    </div>
                                </div>
                                <div class="col-md-1">
                                    <div class="form-group">
                                        <label for="">-</label>
                                        <button class="btn btn-primary btn-block" id="btn_guardar_compra">Registrar</button>
                                    </div>
                                </div>
                                <script>
                                    $('#btn_guardar_compra').click( function () {
                                        ...
                                        var url = "../app/controllers/compras/crear-compras.php";
                                        ...
                                        if (id_producto == "") {
                                            ...
                                            $.get(url, {nro_compra: nro_compra, fecha_compra: fecha_compra, comprobante: comprobante, precio_compra: precio_compra, 
